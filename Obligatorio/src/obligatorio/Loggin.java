...
public class Loggin extends javax.swing.JFrame {
    ...
    public void check() {
        ...
        try {
            ...
            ResultSet consulta = chequeoEstado.executeQuery("SELECT estado FROM obligatorioDB.PERMISOS WHERE user_id = '1212'");
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnloggin, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 230, 130, 40));
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 206, -1, 20));
                ...
                if (consulta.next()) {
                    do {
                        ...
                        if (pass.equals(pas)) {
                            ...
                            this.ci = consulta.getString("user_id");
                            this.dispose();
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        if (txtUser.getText().isEmpty()) {
            ...
            try {
                ...
                Statement stat = conec.createStatement();
                ResultSet consulta = stat.executeQuery("select * from PERSONAS join PERMISOS on PERSONAS.user_id=PERMISOS.user_id where PERSONAS.user_id='" + txtUser.getText() + "'");
                if (consulta.next()) {
                    Loggin.ci = txtUser.getText();
                    RecuperacionPassword recuperar = new RecuperacionPassword();
                    recuperar.setVisible(true);
                }else{
                    JOptionPane.showMessageDialog(null, "EL USUARIO INGRESADO NO COINCIDE CON NINGUN USUARIO VALIDO", "ERROR", JOptionPane.ERROR_MESSAGE);
                }
            } catch (Exception e) {
            }
        }
